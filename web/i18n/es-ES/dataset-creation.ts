const translation = {
  ...
  stepTwo: {
    ...
    noSegment: 'No realizar particionado',
    noSegmentDescription: 'No realizar particionado',
    ...
    QAIndexTitle: 'Segmentación en formato de pregunta y respuesta',
    QAIndexTip: 'Habilitar esta opción consumirá más tokens',
    QAIndexLanguage: 'Segmentar usando',
