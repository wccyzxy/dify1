const translation = {
  ...
  newApp: {
    ...
    pipeline: 'Pipeline',
    pipelineFor: 'For advanced users',
    pipelineDescription: 'Pipeline Orchestrate orchestrates Chatbots in the form of pipelines, offering a high degree of customization, including the ability to edit built-in prompts. It is suitable for experienced users.',
