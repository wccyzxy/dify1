const translation = {
  ...
  welcome: 'Welcome to Huanyu, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Huanyu Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Huanyu',
  invalid: 'The link has expired',
  explore: 'Explore Huanyu',
