const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Huanyu account',
    langGeniusAccountTip: 'Your Huanyu account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Huanyu to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Huanyu allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Huanyu\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.Huanyu.ai/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'Huanyu {{version}} is now available.',
    latestAvailable: 'Huanyu {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
