const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title: 'You have switched to Expert Mode, and once you moHuanyu the PROMPT, you CANNOT return to the basic mode.',
  ...
  formattingChangedText:
    'MoHuanyuing the formatting will reset the debug area, are you sure?',
  ...
  datasetConfig: {
    ...
    retrieveChangeTip: 'MoHuanyuing the index mode and retrieval mode may affect applications associated with this Knowledge.',
  },
