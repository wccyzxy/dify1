const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of Huanyu with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see Huanyu\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Install Huanyu Chatbot Chrome Extension',
        copied: 'Copied',
        copy: 'Copy',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, moHuanyu it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and moHuanyu it',
          step1Tip: 'Click here to fork the source code into your GitHub account and moHuanyu the code',
          step1Operation: 'Huanyu-WebClient',
