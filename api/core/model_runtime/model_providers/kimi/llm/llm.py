...
from core.model_runtime.model_providers.kimi._common import _CommonKimi

logger = logging.getLogger(__name__)

KIMI_BLOCK_MODE_PROMPT = """You should always follow the instructions and output a valid {{block}} object.
...
class KimiLargeLanguageModel(_CommonKimi, LargeLanguageModel):
    """
    Model class for Kimi large language model.
    """
    ...
    def _transform_chat_json_prompts(self, model: str, credentials: dict, 
        ...
        if len(prompt_messages) > 0 and isinstance(prompt_messages[0], SystemPromptMessage):
            ...
            prompt_messages[0] = SystemPromptMessage(
                content=KIMI_BLOCK_MODE_PROMPT
    ...
    def _handle_generate_response(self, model: str, credentials: dict, response: Completion,
        ...
        if response.usage:
            ...
            completion_tokens = self._get_num_tokens_by_gpt2(assistant_text)
    ...
    def _convert_prompt_message_to_dict(self, message: PromptMessage) -> dict:
        """
        Convert PromptMessage to dict for Kimi API
        """
    ...
    def get_customizable_model_schema(self, model: str, credentials: dict) -> AIModelEntity:
        """
            Kimi supports fine-tuning of their models. This method returns the schema of the base model
