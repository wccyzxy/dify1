...
from core.app.entities.app_invoke_entities import PipelineChatAppGenerateEntity, InvokeFrom
...
class PipelineChatAppGenerator(MessageBasedAppGenerator):
    @overload
    def generate(
        self,
        app_model: App,
    ...
    def generate(
        ...
        extras = {
            ...
            "pipeline_query_config": args.get("pipeline_query_config", {}),
        }
        ...
        app_config = PipelineChatAppConfigManager.get_app_config(app_model=app_model, app_model_config=app_model_config)
    ...
    def _generate(
        ...
        *,
        ...
        return PipelineChatAppGenerateResponseConverter.convert(response=response, invoke_from=invoke_from)
    ...
    def _handle_pipeline_chat_response(
        self,
        *,
        application_generate_entity: PipelineChatAppGenerateEntity,
        queue_manager: AppQueueManager,
        ...
        generate_task_pipeline = PipelineChatAppGenerateTaskPipeline(
            application_generate_entity=application_generate_entity,
            queue_manager=queue_manager,
            conversation=conversation,
            message=message,
