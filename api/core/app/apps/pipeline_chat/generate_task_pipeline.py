...
class PipelineChatAppGenerateTaskPipeline(BasedGenerateTaskPipeline, MessageCycleManage):
    """
    PipelineChatAppGenerateTaskPipeline is a class that generate stream output and state management for Application.
    """

    _task_state: PipelineTaskState
    _application_generate_entity: PipelineChatAppGenerateEntity
    ...
    def __init__(
        ...
        self._task_state = PipelineTaskState()
    ...
    def _wrapper_process_stream_response(
        ...
        features_dict = self._application_generate_entity.app_config.app_model_config_dict
    ...
    def _process_stream_response(
        ...
        for queue_message in self._queue_manager.listen():
            ...
            if isinstance(event, QueuePingEvent):
                ...
                break
            elif isinstance(event, QueuePipelineStartedEvent):                
                ...
                self._queue_manager.publish(QueuePipelineChatMessageEndEvent(), PublishFrom.TASK_PIPELINE)
            elif isinstance(event, QueuePipelineFailedEvent):
                print(f'pipeline_failed: {event}')
